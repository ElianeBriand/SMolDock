...
namespace SmolDock {
    ...
    GradientDescentLineSearch::GradientDescentLineSearch(
            std::function<double(const iConformer&, const iTransform&,const iProtein&)> scorFunc, double differentialUpsilon) :
    ...
    bool GradientDescentLineSearch::optimize() {
        ...
        while (score_progress > 0.01) {
            ...
            double step = this->differential_epsilon;
